...
class Relay2Form extends Component {
    ...
    render() {
        ...
        return (
            <SimpleForm
                ...
                toolbar={null}
            >
                <BooleanInput label='Connected' source='relay2.connected' />
                {isRelay2Connected &&
                    <Fragment>
                        <SelectInput label='To contacts' source="relay2.contacts" choices={[
                            { id: 'NO', name: 'Normal Open' },
                            { id: 'NC', name: 'Normal Close' }
                        ]} className={classes.inline} margin='dense' />
                        <NumberInput label='Load value (W)' source='relay2.load' className={classes.inline} margin='dense'/>
                        <TextInput label='Label' source='relay2.label' fullWidth margin='dense'/>
...
const mapStateToProps = state => ({
	isRelay2Connected: selector(state, 'relay2.connected'),
