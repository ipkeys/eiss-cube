package eiss.cube.service.http.process.eiss_api.setup;

import com.google.gson.Gson;
import eiss.cube.json.messages.setup.Input;
import eiss.cube.json.messages.setup.Relay;
import eiss.cube.json.messages.setup.Setup;
import eiss.cube.json.messages.setup.SetupRequest;
import eiss.cube.json.messages.setup.SetupResponse;
...
public class SetupForDeviceRoute implements Handler<RoutingContext> {
    ...
    @Inject
    public SetupForDeviceRoute(Vertx vertx, @Cubes Datastore datastore, Gson gson) {
        this.vertx = vertx;
        this.gson = gson;
